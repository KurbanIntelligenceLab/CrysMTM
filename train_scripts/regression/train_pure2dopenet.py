...
def collate_fn_pure2dopenet(batch):
    ...
    return {"image": images, "text_vector": text_vectors, "regression_label": regression_labels}
    ...
    for target_index, target_name in enumerate(TARGET_PROPERTIES):
        ...
        for seed in SEEDS:
            ...
            train_loader = DataLoader(
                train_dataset, batch_size=BATCH_SIZE, shuffle=True, num_workers=NUM_WORKERS, collate_fn=collate_fn_pure2dopenet
            )
            val_loader = DataLoader(
                val_dataset, batch_size=BATCH_SIZE, shuffle=False, num_workers=NUM_WORKERS, collate_fn=collate_fn_pure2dopenet
            )
            id_loader = DataLoader(
                id_dataset, batch_size=BATCH_SIZE, shuffle=False, num_workers=NUM_WORKERS, collate_fn=collate_fn_pure2dopenet
            )
            ood_loader = DataLoader(
                ood_dataset, batch_size=BATCH_SIZE, shuffle=False, num_workers=NUM_WORKERS, collate_fn=collate_fn_pure2dopenet
            )
